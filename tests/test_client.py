...
from signage import InfobusClient
from signage.exceptions import InfobusAPIError, InfobusConnectionError
...
class TestInfobusClient:
    ...
    def test_client_initialization_with_token(self):
        ...
        client = InfobusClient(base_url="https://api.example.com", token="test-token")
